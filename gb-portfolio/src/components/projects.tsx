  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive university management system built with modern technologies to handle student enrollment, course management, and administrative tasks.",
    ...
    },
    {
      ...
      description:
        "Complete CI/CD pipeline implementation with automated testing, code quality checks, and deployment automation.",
      technologies: [
        "Jenkins",
        "SpringBoot",
        "DockerHub",
    ...
    },
    {
      ...
      description:
        "Scalable microservices architecture for inventory management with service discovery and API gateway implementation.",
      technologies: [
        "SpringBoot",
        "Eureka",
        "Zuul Gateway",
                ...
                <div className="card-actions">
                  <div className="flex flex-wrap gap-1">
                    {project.technologies.map((tech, i) => (
                      <div key={i} className="badge bg-secondary badge-sm">
                        {tech}
                      </div>
                    ))}
                  </div>
